...
from models.neural_odes import Vanilla_NODE, SA_NODE
...
def main():
    ...
    l = 0.2     # l is the length scale of the random field
    ...
    num_epochs_adam = 100000       # Number of epochs for Adam
    ...
    node = SA_NODE(device, data_dim, dim_v, dim_u, hidden_dim, hidden_layers, 'relu', T, time_steps,
                   D_input=True, v_input=True).to(device)
